  ...
  return (
    <div>
      ...
      {presidents.length > 0 ? (
          ...
          {presidents.map((president) => (
            ...
            >
              ...
              <div>
                <small>
                  From{" "}
                  <span className="small !font-medium">{president.from}</span>{" "}
                  to <span className="small !font-medium">{president.to}</span>
                </small>
        ...
        <NoItems
          title="presidents"
          buttonTitle="Add a President"
          route={Routes.ADMIN_ADD_PRESIDENT}
        />
      )}
    </div>
  );
